# Project status log through 11 September 2026

The dated record of how the project reached its current state, moved out of `STATUS.md` on
11 September 2026 so that the status page states the present rather than replaying every
version. Nothing here is the current state of the tool; read
[`STATUS.md`](../../STATUS.md) for that.

Sections are in the order they were written, which is the order they were appended to the old
status page rather than stage or date order. One heading is corrected against the original: the
second `Stage 7, step 5` section recorded step 4's custody and acceptance preflight (PR #66,
runs `34503398871`, `34504032804`, `34503999540`) and is titled step 4 here. No other wording,
figure, run id or digest is changed.
...
## Stage 7, step 4 — custody and acceptance preflight of the combined feature table
